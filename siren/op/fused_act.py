...
fused = load(
    'fused',
    sources=['/apdcephfs/share_1330077/starksun/projects/pi-GAN/siren/op/fused_bias_act.cpp', '/apdcephfs/share_1330077/starksun/projects/pi-GAN/siren/op/fused_bias_act_kernel.cu'],
)
