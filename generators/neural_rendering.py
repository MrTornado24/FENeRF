...
class NeuralRenderer(nn.Module):
    ...
    def __init__(
            ...
            min_feat=32, img_size=64, input_size=16, use_rgb_skip=True,
        ...
        n_blocks = int(log2(img_size) - log2(input_size))
    ...
    def forward(self, x):
        # x: (n_batch, n_channel, n_res, n_res)
