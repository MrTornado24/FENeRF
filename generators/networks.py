...
import math
# from .util import *
# from ..siren.op import FusedLeakyReLU, fused_leaky_relu, upfirdn2d
...
class ImageEncoder(nn.Module):
    ...
    def __init__(self, backbone="resnet34", pretrained=True, latent_size=128):
        ...
        """
        super().__init__()
        self.model = getattr(torchvision.models, backbone)(pretrained=False)
        self.model.load_state_dict(torch.load('/apdcephfs/share_1330077/starksun/projects/giraffe/data/pretrained_models/resnet34-333f7ec4.pth'))
